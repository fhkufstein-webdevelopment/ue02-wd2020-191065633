...
Ihre Antwort:ASP,JSP,PHP,JavaScript=>node.js

### Mit welchen Technologien (Programmiersprachen etc.) muss ein Backendentwickler typischerweise arbeiten?

Ihre Antwort:HTML,XML,CSS,JavaScript

### Vervollständigen Sie bitte:

Ein Backentwickler entwickelt typischerweise clientseitig.

Ein Frontentwickler entwickelt typischerweise serverseitig.
...
Git ist ein Version Control System. Nennen Sie 2 weitere. CVS, Subversion
